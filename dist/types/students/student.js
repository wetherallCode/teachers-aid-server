...
exports.StudentCohortEnum = exports.Student = void 0;
const schema_1 = require("@nexus/schema");
const users_1 = require("../users");
const __1 = require("..");
const mongodb_1 = require("mongodb");
const responsibilityPoints_1 = require("./responsibilityPoints/responsibilityPoints");
exports.Student = schema_1.objectType({
    ...
    definition(t) {
        ...
        t.boolean('virtual');
        t.field('cohort', { type: exports.StudentCohortEnum });
            ...
            resolve(parent, __, { assignmentData }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const assignments = yield assignmentData
                        .find({
                        'hasOwner._id': new mongodb_1.ObjectId(parent._id),
        ...
        t.list.field('hasProtocols', {
            type: 'Protocol',
            resolve(parent, __, { protocolData }) {
                return __awaiter(this, void 0, void 0, function* () {
...
exports.StudentCohortEnum = schema_1.enumType({
