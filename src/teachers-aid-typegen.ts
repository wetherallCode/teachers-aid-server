...
export interface NexusGenEnums {
  ...
  QuestionUsageTypeEnum: "ESSAY" | "TEST"
...
export interface NexusGenRootTypes {
  ...
  Question: NexusGenRootTypes['EssayQuestion'];
