...
export interface NexusGenInputs {
  ...
  CreateTextSectionInput: { // input type
    ...
    pages: string; // String!
    vocab: NexusGenInputs['VocabInput'][]; // [VocabInput!]!
  }
