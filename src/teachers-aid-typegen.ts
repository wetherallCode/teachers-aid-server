...
export interface NexusGenFieldTypes {
  ...
  TextAnalysis: { // field return type
    ...
    dueTime: string; // String!
    exempt: boolean; // Boolean!
    finishedEssential Question: boolean; // Boolean!
    gradeType: NexusGenEnums['GradeTypeEnum']; // GradeTypeEnum!
    hasAssigner: NexusGenRootTypes['Teacher']; // Teacher!
    hasOwner: NexusGenRootTypes['Student']; // Student!
    late: boolean; // Boolean!
...
export type NexusGenObjectNames =
  ...
  | 'ActivateQuizPayload'
  | 'AddAssociatedCourseIdPayload'
  | 'AddCourseToTeacherPayload'
  | 'AddDeskToAssignedSeatsPayload'
  | 'AddFieldsToReadingGuidePayload'
  | 'AddForcedFinishedToAllQuizzesPayload'
  | 'AddIEPInfoPayload'
  | 'AddNewChapterPayload'
  | 'AddNewTextPayload'
  ...
  | 'AnswerList'
  | 'ArticleReview'
  | 'AssessIndividualProtocolsPayload'
  | 'AssessStudentProtocolPayload'
  | 'AssignEssaysPayload'
  | 'AssignQuizzesByStudentIdsAndDatePayload'
  | 'AssignReadingGuidesPayload'
  | 'AssignSeatsPayload'
  | 'AssignTextAnalysesPayload'
  | 'BehaviorType'
  | 'BuildRubricEntryPayload'
  | 'ChangeAllQuizzesToSecondMarkingPeriodPayload'
  | 'ChangeEssayDueDateAndAssignedDateByReadingSectionPayload'
  | 'ChangePasswordPayload'
  | 'ChangeQuizDueDateAndAssignedDateByReadingSectionPayload'
  | 'Chapter'
  | 'CheckAssignmentsAllowedInClassPayload'
  | 'CheckQuizQuestionsForTextSectionsPayload'
  | 'CheckTextAnalysisPayload'
  | 'ComprehensionMetrics'
  | 'ContactInfo'
  | 'ControlCoolDownPayload'
  | 'ControlWarmUpPayload'
  | 'Course'
  | 'CourseInfo'
  | 'CreateAbsencePayload'
  | 'CreateArticleReviewsPayload'
  | 'CreateBatchStudentBehaviorPayload'
  | 'CreateBehaviorTypePayload'
  | 'CreateCourseInfoPayload'
  | 'CreateCoursePayload'
  | 'CreateEssayPayload'
  | 'CreateEssayQuestionPayload'
  | 'CreateEssentialQuestionPayload'
  | 'CreateExcusedLatenessPayload'
  | 'CreateLatenessPayload'
  | 'CreateLessonPayload'
  | 'CreateParentContactPayload'
  | 'CreateProfessionalDevelopmentPayload'
  | 'CreateProgressMetricsPayload'
  | 'CreateProgressTrackerForStudentPayload'
  | 'CreateProtocolPayload'
  | 'CreateQuizQuestionPayload'
  | 'CreateQuizzesByCoursePayload'
  | 'CreateReadingGuidePayload'
  | 'CreateResponsibilityPointsPayload'
  | 'CreateSchoolDayPayload'
  | 'CreateSchoolDayTrackerPayload'
  | 'CreateSignInSheetsPayload'
  | 'CreateStudentBehaviorPayload'
  | 'CreateStudentOutOfClassPayload'
  | 'CreateStudentQuestionPayload'
  | 'CreateStudentQuestionsContainerPayload'
  | 'CreateTemporaryTasksPayload'
  | 'CreateTextAnalysisPayload'
  | 'CreateTextSectionPayload'
  | 'CreateUnexcusedLatenessPayload'
  | 'CreateUnitPayload'
  | 'CreateWritingMetricsPayload'
  | 'DeleteAllAssignmentsPayload'
  | 'DeleteAllLessonsPayload'
  | 'DeleteAllParentContactsPayload'
  | 'DeleteAllProtocolsPayload'
  | 'DeleteAllSchoolDaysPayload'
  | 'DeleteAllStudentDataPayload'
  | 'DeleteAllStudentsPayload'
  | 'DeleteAllTemporaryTasksPayload'
  | 'DeleteBehaviorTypePayload'
  | 'DeleteQuizzesByDatePayload'
  | 'DeleteReadingGuideByDatePayload'
  | 'DeleteReviewsPayload'
  | 'DeleteStudentOutOfClassPayload'
  | 'DeleteTemporaryTasksPayload'
  | 'DevelopingOrganizer'
  | 'DevelopingSentenceStructure'
  | 'EditBehaviorTypesPayload'
  | 'EmergencyModificationPayload'
  | 'Essay'
  | 'EssayQuestion'
  | 'EssentialQuestion'
  | 'ExcusedLateness'
  | 'ExemptArticleReviewPayload'
  | 'FinalDraftContainer'
  | 'FindActiveProtocolByStudentPayload'
  | 'FindActiveProtocolsByCoursePayload'
  | 'FindAllBehaviorTypesPayload'
  | 'FindAllCourseTitlesPayload'
  | 'FindAllMarkingPeriodGradesPayload'
  | 'FindAllQuestionsPayload'
  | 'FindAllStudentsPayload'
  | 'FindAllUsersPayload'
  | 'FindArticleReviewByIdPayload'
  | 'FindArticleReviewsByCoursePayload'
  | 'FindArticleReviewsByStudentPayload'
  | 'FindAssignmentByIdPayload'
  | 'FindAssignmentByStudentIdPayload'
  | 'FindAssignmentsByCourseIdPayload'
  | 'FindAssignmentsToGradePayload'
  | 'FindBehaviorsByStudentIdAndDatePayload'
  | 'FindChapterTitlePayload'
  | 'FindChaptersByTextIdPayload'
  | 'FindChaptersInTextPayload'
  | 'FindCompletedEssaysByStudentIdPayload'
  | 'FindContactsByStudentIdPayload'
  | 'FindCourseByIdPayload'
  | 'FindCourseInfoByCourseIdPayload'
  | 'FindCoursesByIdPayload'
  | 'FindCurrentMarkingPeriodPayload'
  | 'FindEssayByIdPayload'
  | 'FindEssayByStudentIdAndLessonIdPayload'
  | 'FindEssayQuestionByIdPayload'
  | 'FindEssayQuestionsForLessonPayload'
  | 'FindEssaysByAssociatedLessonIdAndCourseIdPayload'
  | 'FindEssaysByAssociatedLessonIdPayload'
  | 'FindEssaysByCourseIdAndTitlePayload'
  | 'FindEssaysByStudentIdPayload'
  ...
  | 'FindEssentialQuestionsByAssociatedTextSectionIdsPayload'
  | 'FindLessonByCourseAndDatePayload'
  | 'FindLessonByCoursePayload'
  | 'FindLessonByIdPayload'
  | 'FindLessonStatusPayload'
  | 'FindLessonsByAssignedDatePayload'
  | 'FindLessonsByUnitPayload'
  | 'FindParentContactsByTeacherIdPayload'
  | 'FindProtocolResponsesPayload'
  | 'FindQuizByIdPayload'
  | 'FindQuizQuestionsByQuizzableSectionsPayload'
  | 'FindQuizQuestionsByTextSectionIdPayload'
  | 'FindQuizzesByStudentIdPayload'
  | 'FindQuizzesForCourseByAssignedDatePayload'
  | 'FindReadingGuideByIdPayload'
  | 'FindReadingGuideByUserIdAndReadingSectionPayload'
  | 'FindReadingGuidesByAssociatedLessonAndCourseIdPayload'
  | 'FindReadingGuidesByCourseIdAndAssignedDatePayload'
  | 'FindReadingGuidesByMarkingPeriodPayload'
  | 'FindReadingGuidesByReadingSectionPayload'
  | 'FindReadingGuidesToCompleteByStudentIdPayload'
  | 'FindResponsibilityPointsByCoursePayload'
  | 'FindResponsibilityPointsByStudentIdPayload'
  | 'FindRubricEntriesByCategoryPayload'
  | 'FindRubricEntriesPayload'
  | 'FindSGOEssaysByStudentIdPayload'
  | 'FindSchoolDayAndLessonPayload'
  | 'FindSchoolDayByDatePayload'
  | 'FindSchoolDayPayload'
  | 'FindStudentByIdForTeachersAidPayload'
  | 'FindStudentByIdPayload'
  | 'FindStudentOutOfClassByPeriodNameAndDatePayload'
  | 'FindStudentOutOfClassByStudentIdAndMarkingPeriodPayload'
  | 'FindStudentOutOfClassPayload'
  | 'FindStudentQuestionsPayload'
  | 'FindStudentsByCoursePayload'
  | 'FindStudentsByIdPayload'
  | 'FindTemporaryTasksByStudentIdPayload'
  | 'FindTemporaryTasksPayload'
  | 'FindTextAnalysesByCourseIdAndDueDatePayload'
  | 'FindTextAnalysisByStudentIdAndDueDatePayload'
  | 'FindTextByTitlePayload'
  ...
  | 'FindUnitsPayload'
  | 'FindUserDataPayload'
  | 'FindWritingMetricsPayload'
  | 'FinishProtocolPayload'
  | 'FinishQuizPayload'
  | 'FixEssayByEssayIdPayload'
  | 'ForceFinishQuizPayload'
  | 'GradeArticleReviewPayload'
  | 'GradeTemporaryTaskPayload'
  ...
  | 'LessonTextSections'
  | 'LoginPayload'
  | 'MarkAllProtocolsInactivePayload'
  | 'MarkExemptPayload'
  | 'MarkLessonForSGOPayload'
  | 'MarkTemporaryTaskAbsentPayload'
  | 'MarkingPeriod'
  | 'ModifiyEssayQuestionsPayload'
  | 'ModifyAssignmentsPayload'
  | 'ModifyCourseInfoPayload'
  | 'ModifyEssayDueDateAndAssignedDatePayload'
  | 'ModifyExistingStudentBehaviorsPayload'
  | 'ModifyLessonAttributesPayload'
  | 'ModifyLessonDateByOriginalDatePayload'
  | 'ModifyLessonUnitPayload'
  | 'ModifyLessonsByAssignedDayPayload'
  | 'ModifyStudentOutOfClassPayload'
  | 'ModifyTextSectionsPayload'
  | 'Mutation'
  ...
  | 'QuizQuestion'
  | 'ReadingGuide'
  | 'ReadingGuideFinalContainer'
  | 'ReadingGuideMetric'
  | 'ReadingGuideQuestion'
  | 'Readings'
  | 'RegisterStudentPayload'
  | 'RegisterTeacherPayload'
  | 'RemoveAbsencePayload'
  | 'RemoveAssignedSeatPayload'
  | 'RemoveCoursePayload'
  | 'RemoveLatenessPayload'
  | 'RemoveProtocolPayload'
  | 'RemoveRubricEntryPayload'
  | 'RemoveSchoolDayPayload'
  | 'RemoveStudentBehaviorPayload'
  | 'RemoveStudentsFromCoursePayload'
  | 'RemoveSubmittedEssayFinalDraftPayload'
  | 'RemoveTextSectionPayload'
  | 'ResetAllEssayQuestionsSGOStatusPayload'
  | 'ResetPasswordPayload'
  | 'RespondToProtocolPayload'
  | 'ResponsibilityPoints'
  | 'ResubmitEssayFinalDraftPayload'
  | 'ReturnArticleReviewPayload'
  | 'ReturnGradedEssayPayload'
  | 'ReturnReadingGuidePayload'
  | 'ReviewReadingGuidesPayload'
  | 'RubricEntry'
  | 'SGO'
  | 'SchoolDay'
  | 'SchoolDayModifierPayload'
  | 'SchoolDayTracker'
  | 'Score'
  | 'SetAnswerTypePayload'
  | 'SetCurrentMarkingPeriodPayload'
  | 'SetOrganizerPayload'
  | 'SetRestatementPayload'
  | 'SpecialAssignment'
  | 'StartProtocolPayload'
  | 'StartQuizPayload'
  | 'StartReadingGuidePayload'
  | 'Student'
  | 'StudentAbsence'
  | 'StudentBehavior'
  | 'StudentForTeachersAid'
  | 'StudentInformation'
  | 'StudentLateness'
  | 'StudentOutOfClass'
  | 'StudentQuestion'
  | 'StudentQuestions'
  | 'StudentReturnedToClassPayload'
  | 'StudentSeat'
  | 'StudentSignInPayload'
  | 'StudentSignInSheet'
  | 'SubmitArticleReviewPayload'
  | 'SubmitEssayFinalDraftPayload'
  | 'SubmitReadingGuidePayload'
  | 'SubmittedFinalDraft'
  | 'SwitchToNewCoursePayload'
  | 'Teacher'
  | 'TemporaryTask'
  | 'Text'
  | 'TextAnalysis'
  ...
  | 'TextSectionVocab'
  | 'ToggleAssignmentsAllowedInClassPayload'
  | 'ToggleClassAssignmentsAllowedPayload'
  | 'ToggleReadingGuideCheckPayload'
  | 'Topic'
  | 'UnAssignEssaysPayload'
  | 'UnAssignQuizByQuizIdPayload'
  | 'UnexcusedLateness'
  | 'Unit'
  | 'UpdateAcademicOrganizerPayload'
  | 'UpdateAdvancedOrganizerPayload'
  | 'UpdateArticleReviewPayload'
  | 'UpdateCourseInfoPayload'
  | 'UpdateDevelopingOrganizerPayload'
  | 'UpdateDynamicLessonPayload'
  | 'UpdateEssayByStudentPayload'
  | 'UpdateEssayLatenessPayload'
  ...
  | 'UpdateLessonPayload'
  | 'UpdateParentContactPayload'
  | 'UpdateProblemSolutionPayload'
  | 'UpdateProtocolPayload'
  | 'UpdateReadingGuidePayload'
  | 'UpdateResponsibilityPointsPayload'
  | 'UpdateRubricEntryPayload'
  | 'UpdateSchoolDayPayload'
  | 'UpdateTemporaryTasksPayload'
  | 'UpdateTextSectionPayload'
...
export type NexusGenInputNames =
  ...
  | 'ActivateQuizInput'
  | 'AddCourseToTeacherInput'
  | 'AddDeskToAssignedSeatsInput'
  | 'AddNewChapterInput'
  | 'AddNewTextInput'
  ...
  | 'AnswerListInput'
  | 'AssessIndividualProtocolsInput'
  | 'AssessStudentProtocolInput'
  | 'AssignEssaysInput'
  | 'AssignQuizzesByStudentIdsAndDateInput'
  | 'AssignReadingGuidesInput'
  | 'AssignSeatsInput'
  | 'AssignTextAnalysesInput'
  | 'BuildRubricEntryInput'
  | 'ChangeEssayDueDateAndAssignedDateByReadingSectionInput'
  | 'ChangePasswordInput'
  | 'ChangeQuizDueDateAndAssignedDateByReadingSectionInput'
  | 'ChangeVocabWordInput'
  | 'CheckAssignmentsAllowedInClassInput'
  | 'CheckQuizQuestionsForTextSectionsInput'
  | 'CheckTextAnalysisInput'
  | 'ControlCoolDownInput'
  | 'ControlWarmUpInput'
  | 'CourseInput'
  | 'CreateAbsenceInput'
  | 'CreateArticleReviewsInput'
  | 'CreateBatchStudentBehaviorInput'
  | 'CreateBehaviorTypeInput'
  | 'CreateCourseInfoInput'
  | 'CreateCourseInput'
  | 'CreateEssayInput'
  | 'CreateEssayQuestionInput'
  | 'CreateEssentialQuestionInput'
  | 'CreateExcusedLatenessInput'
  | 'CreateLatenessInput'
  | 'CreateLessonInput'
  | 'CreateParentContactInput'
  | 'CreateProfessionalDevelopmentInput'
  | 'CreateProgressMetricsInput'
  | 'CreateProgressTrackerForStudentInput'
  | 'CreateProtocolInput'
  | 'CreateQuizQuestionInput'
  | 'CreateQuizzesByCourseInput'
  | 'CreateReadingGuideInput'
  | 'CreateResponsibilityPointsInput'
  | 'CreateSchoolDayInput'
  | 'CreateSignInSheetsInput'
  | 'CreateStudentBehaviorInput'
  | 'CreateStudentOutOfClassInput'
  | 'CreateStudentQuestionInput'
  | 'CreateStudentQuestionsContainerInput'
  | 'CreateTemporaryTasksInput'
  | 'CreateTextAnalysisInput'
  | 'CreateTextSectionInput'
  | 'CreateUnexcusedLatenessInput'
  | 'CreateUnitInput'
  | 'DeleteBehaviorTypeInput'
  | 'DeleteQuizzesByDateInput'
  | 'DeleteReadingGuideByDateInput'
  | 'DeleteReviewsInput'
  | 'DeleteStudentOutOfClassInput'
  | 'DeleteTemporaryTasksInput'
  | 'DevelopingOrganizerInput'
  | 'DevelopingSentenceStructureInput'
  | 'EditBehaviorTypesInput'
  | 'ExemptArticleReviewInput'
  | 'FindActiveProtocolByStudentInput'
  | 'FindActiveProtocolsByCourseInput'
  | 'FindAllMarkingPeriodGradesInput'
  | 'FindArticleReviewByIdInput'
  | 'FindArticleReviewsByCourseInput'
  | 'FindArticleReviewsByStudentInput'
  | 'FindAssignmentByIdInput'
  | 'FindAssignmentByStudentIdInput'
  | 'FindAssignmentsByCourseIdInput'
  | 'FindAssignmentsToGradeInput'
  | 'FindBehaviorsByStudentIdAndDateInput'
  | 'FindChapterTitleInput'
  | 'FindChaptersByTextIdInput'
  | 'FindChaptersInTextInput'
  | 'FindCompletedEssaysByStudentIdInput'
  | 'FindContactsByStudentIdInput'
  | 'FindCourseByIdInput'
  | 'FindCourseInfoByCourseIdInput'
  | 'FindCoursesByIdInput'
  | 'FindEssayByIdInput'
  | 'FindEssayByStudentIdAndLessonIdInput'
  | 'FindEssayQuestionByIdInput'
  | 'FindEssayQuestionsForLessonInput'
  | 'FindEssaysByAssociatedLessonIdAndCourseIdInput'
  | 'FindEssaysByAssociatedLessonIdInput'
  | 'FindEssaysByCourseIdAndTitleInput'
  | 'FindEssaysByStudentIdInput'
  | 'FindEssaysByTopicInput'
  | 'FindEssaysByUserNameAndMarkingPeriodInput'
  | 'FindEssaysToCompleteByStudentIdInput'
  | 'FindEssaysToGradeByIdInput'
  | 'FindEssentialQuestionsByAssociatedTextSectionIdsInput'
  | 'FindLessonByCourseAndDateInput'
  | 'FindLessonByCourseInput'
  | 'FindLessonByIdInput'
  | 'FindLessonStatusInput'
  | 'FindLessonsByAssignedDateInput'
  | 'FindLessonsByUnitInput'
  | 'FindParentContactsByTeacherIdInput'
  | 'FindProtocolResponsesInput'
  | 'FindQuizByIdInput'
  | 'FindQuizQuestionsByQuizzableSectionsInput'
  | 'FindQuizQuestionsByTextSectionIdInput'
  | 'FindQuizzesByStudentIdInput'
  | 'FindQuizzesForCourseByAssignedDateInput'
  ...
  | 'FindReadingGuidesByCourseIdAndAssignedDateInput'
  | 'FindReadingGuidesByMarkingPeriodInput'
  | 'FindReadingGuidesByReadingSectionInput'
  | 'FindReadingGuidesToCompleteByStudentIdInput'
  | 'FindResponsibilityPointsByCourseInput'
  | 'FindResponsibilityPointsByStudentIdInput'
  | 'FindRubricEntriesByCategoryInput'
  | 'FindSGOEssaysByStudentIdInput'
  | 'FindSchoolDayAndLessonInput'
  | 'FindSchoolDayByDateInput'
  | 'FindStudentByIdForTeachersAidInput'
  | 'FindStudentByIdInput'
  | 'FindStudentOutOfClassByPeriodNameAndDateInput'
  | 'FindStudentOutOfClassByStudentIdAndMarkingPeriodInput'
  | 'FindStudentOutOfClassInput'
  | 'FindStudentQuestionsInput'
  | 'FindStudentsByCourseInput'
  | 'FindStudentsByIdInput'
  | 'FindTemporaryTasksByStudentIdInput'
  | 'FindTemporaryTasksInput'
  | 'FindTextAnalysesByCourseIdAndDueDateInput'
  | 'FindTextAnalysisByStudentIdAndDueDateInput'
  | 'FindTextByTitleInput'
  | 'FindTextSectionByIdInput'
  | 'FindTextSectionsByChapterInput'
  | 'FindTextSectionsByIdInput'
  | 'FindUserDataInput'
  | 'FindWritingMetricsInput'
  | 'FinishProtocolInput'
  | 'FinishQuizInput'
  | 'ForceFinishQuizInput'
  | 'GradeArticleReviewInput'
  | 'GradeTemporaryTaskInput'
  | 'HasAssigner'
  | 'HasOwnerInput'
  | 'InitializeStudentsInput'
  | 'LessonTextSectionsInput'
  | 'LoginInput'
  | 'MarkExemptInput'
  | 'MarkLessonForSGOInput'
  | 'MarkTemporaryTaskAbsentInput'
  | 'ModifyEssayDueDateAndAssignedDateInput'
  | 'ModifyLessonDateByOriginalDateInput'
  | 'ModifyLessonUnitInput'
  | 'ModifyLessonsByAssignedDayInput'
  | 'ModifyStudentOutOfClassInput'
  | 'PageNumbersInput'
  | 'PasswordCheckInput'
  | 'QuestionAndAnswerListInput'
  | 'QuestionPartsContainerInput'
  | 'ReadingGuideQuestionInput'
  | 'ReadingsInput'
  | 'RegisterStudentInput'
  | 'RegisterTeacherInput'
  | 'RemoveAbsenceInput'
  | 'RemoveAssignedSeatInput'
  | 'RemoveCourseInput'
  | 'RemoveLatenessInput'
  | 'RemoveProtocolInput'
  | 'RemoveRubricEntryInput'
  | 'RemoveSchoolDayInput'
  | 'RemoveStudentBehaviorInput'
  | 'RemoveStudentsFromCourseInput'
  | 'RemoveSubmittedEssayFinalDraftInput'
  | 'RemoveTextSectionInput'
  | 'ResetPasswordInput'
  | 'RespondToProtocolInput'
  | 'ResubmitEssayFinalDraftInput'
  | 'ReturnArticleReviewInput'
  | 'ReturnGradedEssayInput'
  | 'ReturnReadingGuideInput'
  | 'ReturnedRubricEntryInput'
  | 'ReviewReadingGuidesInput'
  | 'RubricEntryInput'
  | 'SetAnswerTypeInput'
  | 'SetCurrentMarkingPeriodInput'
  | 'SetOrganizerInput'
  | 'SetRestatementInput'
  | 'StartProtocolInput'
  | 'StartQuizInput'
  | 'StartReadingGuideInput'
  | 'StudentReturnedToClassInput'
  | 'StudentSeatInput'
  | 'StudentSignInInput'
  | 'SubmitArticleReviewInput'
  | 'SubmitEssayFinalDraftInput'
  | 'SubmitReadingGuideInput'
  | 'SubmittedFinalDraftsInput'
  | 'SwitchToNewCourseInput'
  | 'TextChapterInput'
  | 'TextInput'
  | 'TextSectionProtocolsInput'
  | 'TextSectionQuestionsInput'
  | 'TextSectionVocabInput'
  | 'ToggleAssignmentsAllowedInClassInput'
  | 'ToggleClassAssignmentsAllowedInput'
  | 'ToggleReadingGuideCheckInput'
  | 'TopicInput'
  | 'TopicTypeInput'
  | 'UnAssignEssaysInput'
  | 'UnAssignQuizByQuizIdInput'
  | 'UnitInput'
  | 'UpdateAcademicOrganizerInput'
  | 'UpdateAdvancedOrganizerInput'
  | 'UpdateArticleReviewInput'
  | 'UpdateCourseInfoInput'
  | 'UpdateDevelopingOrganizerInput'
  | 'UpdateDynamicLessonInput'
  | 'UpdateEssayByStudentInput'
  | 'UpdateEssayLatenessInput'
  | 'UpdateEssaysByLessonInput'
  | 'UpdateEssaysByQuestionInput'
  | 'UpdateEssaysByStudentsAndSectionInput'
  | 'UpdateGradingDraftInput'
  | 'UpdateHowCauseEffectInput'
  | 'UpdateLessonInput'
  | 'UpdateLessonProtocolInput'
  | 'UpdateParentContactInput'
  | 'UpdateProblemSolutionInput'
  | 'UpdateReadingGuideInput'
  | 'UpdateResponsibilityPointsInput'
  | 'UpdateRubricEntryInput'
  | 'UpdateSchoolDayInput'
  | 'UpdateTemporaryTasksInput'
  | 'UpdateTextSectionInput'
  | 'UpdateUserActiveInput'
  | 'UpdateWhyCauseEffectInput'
